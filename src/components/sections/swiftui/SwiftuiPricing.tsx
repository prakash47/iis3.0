...
// copying a web-spoke assembly would emit the wrong five web tiers into the Offer schema. Both tiers
// must be VISIBLE (Offer integrity). Never invent a middle tier.
//
// RENDER ALL BULLETS (mirror FlutterPricing; do NOT slice). The bullets are TRUE and PROTECTIVE, and
// they literally read "Cross-platform (React Native or Flutter)" and "no complex backend" - written
// for cross-platform pricing. On a NATIVE page the mapping panel has to work harder than Flutter's:
// it must (i) reconcile that cross-platform bullet on a native page, (ii) state native iOS sits AT or
// ABOVE the $15,000 tier because native is the pricier route, and (iii) state the $500 Starter is
// emphatically NOT a native iOS app. Suppressing the bullets would remove the guardrail, not add one.
export function SwiftuiPricing() {
  return (
    <Section id="pricing">
      <Container>
        <Reveal>
          <SectionHeading
            eyebrow="Pricing"
            title="What a native SwiftUI app costs"
        ...
        {/* MANDATORY mapping panel. It reconciles the cross-platform wording on a native page, makes
            the native-is-the-pricier-route point explicit, and kills the "a native iOS app from $500"
        ...
        <Reveal className="mt-6">
          <div className="rounded-2xl border border-border bg-muted/50 p-6">
            ...
            <p className="mt-2 max-w-3xl text-sm leading-relaxed text-muted-foreground">
              ...
              hide it. Native SwiftUI is the pricier path, not the cheaper one: a real, product-grade
              native iOS build - screens, data, the Apple SDKs it integrates, a backend, real-device QA
              and App Store submission - sits at or above the{" "}
              ...
              SwiftUI app; please don&apos;t read it as one. App Store submission is included, and the
              Apple Developer account is registered in your name. The honest way to a real number is a
              short discovery: tell us the app and your budget and we&apos;ll scope one fixed price, in
