...
// A React app/site is priced by the same published web tiers used on /pricing and
// the web-dev money page - single source of truth, byte-identical. Publishing real
// numbers is a differentiator (React agency pages almost all hide pricing).
export function ReactPricing() {
  return (
    <Section id="pricing">
      <Container>
        <Reveal>
          <SectionHeading
            eyebrow="Pricing"
            title="What a React app costs"
            sub="No quote wall. A React build is priced by our published web tiers - the same numbers on our pricing page and everywhere else. You always see the price before you commit."
          />
        </Reveal>
